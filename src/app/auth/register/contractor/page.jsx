...
import contractorRoles from '../../../data/contractorRoles.json';
...
export default function ContractorRegisterPage() {
  ...
  const roleOptions = contractorRoles.map((item) => ({ label: item, value: item }));
  ...
  return (
    <div className={styles.container}>
      <div className={styles.formContainer}>
        <h2 className={styles.title}>إنشاء حساب مقاول</h2>
